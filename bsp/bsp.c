...
void bsp_pwm_config(void) {
	...
	//calcular x TIM_config.TIM_Period=x;
	//calcular x TIM_config.TIM_Prescaler=x;
	TIM_config.TIM_Period = 10000;  // 10 ms = 10000;
	...
	GPIO_PinAFConfig(GPIOD,GPIO_Pin_15,GPIO_AF_TIM4);// configura funcion alternativa del pin
